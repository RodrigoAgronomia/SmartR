...
rst_rsmed <- summarise_all(rst_pts, median )
rst_rssd <- summarise_all(rst_pts, sd)
...
## Pipe  forma avançada de programação ----------------------------------------------------------

pols_rsm <- rst %>% # %>% passagem de informação por variaveis
